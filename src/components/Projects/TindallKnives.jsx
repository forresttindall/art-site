...
const TindallKnives = () => {
  ...
  return (
    <div className="page-content">
      ...
      <br></br>
      <p className="mono-text">
        J F Tindall Spent over a decade working as a bladesmith. Launching Tindall Knives in 2012. Tindall quickly became a viral sensation shortly after. He released a limited series of knives dubbed the Summit Knife with Best Made Co. in NYC in 2017 which sold out instantly.
      </p>
      <br></br>
      <p className="mono-text">
