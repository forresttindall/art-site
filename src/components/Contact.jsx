  ...
  return (
    <div className="contact-section">
      <div className="contact-content">
        ...
        <p className="mono-text">
          <span className="bold">Instagram:</span> <a className="project-link" href="https://www.instagram.com/forrest.creates/" target="_blank" >@Forrest.creates</a>
        </p>
        
         <p className="mono-text">
          <span className="bold">Threads:</span> <a className="project-link" href="https://www.threads.com/@forrest.tindall" target="_blank" >@Forrest.creates</a>
        </p>
